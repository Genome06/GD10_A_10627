...
import com.example.gd10_a_10627.databinding.ListDataMahasiswaBinding
...
class MahasiswaAdapter (
    ...
    Int): MahasiswaViewHolder {
        return MahasiswaViewHolder(ListDataMahasiswaBinding.inflate(LayoutInflater.from(parent.context),
            parent,false
        ))
    }
